...
//			com.csuperviseframework.core.util.LogUtil.info(after_code);
//			com.csuperviseframework.core.util.LogUtil.info(after_code_zimu);
//			com.csuperviseframework.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// com.csuperviseframework.core.util.LogUtil.info(getNextZiMu('C'));
		// com.csuperviseframework.core.util.LogUtil.info(getNextNum(8));
	    // com.csuperviseframework.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
